...
PRIVACY_DOC_PATH="$ROOT_DIR/docs/release-privacy-sandbox.md"
PRIVACY_POLICY_DRAFT_PATH="$ROOT_DIR/docs/release-privacy-policy-draft.md"
APP_STORE_PRIVACY_ANSWERS_PATH="$ROOT_DIR/docs/release-app-store-privacy-answers.md"
