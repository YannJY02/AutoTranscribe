...
- [ ] First public channel is chosen: Developer ID, Mac App Store, or both with an order.
- [ ] Submitted-build cloud behavior is chosen: local-only or optional BYOK cloud providers.
- [ ] Any privacy-policy language that depends on this choice is identified.
- [ ] Any App Store privacy answers that depend on this choice are identified.
- [ ] The decision is recorded in this issue comments or a follow-up ADR if it becomes a durable product decision.
