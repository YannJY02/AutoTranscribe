...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("By Friday, Yann will submit the report.", "friday", id="en-leading-bound-with-named-subject"),
        pytest.param("By Friday, the team will submit the report.", "friday", id="en-leading-bound-with-team-subject"),
        pytest.param("By Friday, Yann will not submit the report.", "", id="en-leading-named-subject-keeps-negation"),
        pytest.param("By Friday, the team will not submit the report.", "", id="en-leading-team-subject-keeps-negation"),
        pytest.param("By Friday, Yann might submit the report.", "", id="en-leading-named-subject-keeps-uncertainty"),
        pytest.param("By Friday, maybe Yann will submit the report.", "", id="en-leading-subject-cannot-absorb-uncertainty"),
        pytest.param("By Friday, Yann will hold a meeting.", "", id="en-leading-named-subject-needs-completion"),
        pytest.param("By Friday, the team will submit the report, tentatively.", "", id="en-leading-team-action-keeps-tentative-qualifier"),
        pytest.param("Submit the draft and do not deliver the final report by Friday.", "", id="en-next-action-with-do-not-keeps-negation"),
        pytest.param("Submit the draft and do not deliver the final report after Friday.", "friday", id="en-next-action-do-not-after-keeps-upper-bound"),
        pytest.param("We agreed not to submit the report by Friday.", "", id="en-infinitive-completion-keeps-negation"),
        pytest.param("We agreed to submit the report by Friday.", "friday", id="en-affirmed-infinitive-completion"),
        pytest.param("We agreed not to submit the draft and will deliver the final report by Friday.", "friday", id="en-negated-infinitive-before-independent-deadline"),
        pytest.param("The deadline's Friday.", "friday", id="en-contracted-deadline-copula"),
        pytest.param("The deadline’s Friday.", "friday", id="en-curly-contracted-deadline-copula"),
        pytest.param("The deadline's not Friday.", "", id="en-contracted-deadline-keeps-negation"),
        pytest.param("The deadline’s maybe Friday.", "", id="en-contracted-deadline-keeps-uncertainty"),
        pytest.param("The deadline's Friday, tentatively.", "", id="en-contracted-deadline-keeps-tentative-qualifier"),
        pytest.param("The deadline's owner will meet on Friday.", "", id="en-possessive-deadline-is-not-a-date-predicate"),
        pytest.param("Submit the report starting Monday and finish by Friday.", "friday", id="en-start-date-before-independent-finish-deadline"),
        pytest.param("Submit the report from Monday to Friday.", "", id="en-completion-range-does-not-affirm-a-deadline"),
        pytest.param("Submit the report between Monday and Friday.", "", id="en-between-range-does-not-affirm-a-deadline"),
        pytest.param("Submit the report starting Monday and do not finish by Friday.", "", id="en-start-date-before-negated-finish"),
        pytest.param("Submit the report from finance by Friday.", "friday", id="en-from-object-complement-keeps-deadline"),
        pytest.param("Submit the report Monday.", "monday", id="en-direct-completion-date-without-range"),
        pytest.param("Submit the report by Monday.", "monday", id="en-explicit-completion-bound-without-range"),
        pytest.param("Submit feedback from Monday's meeting by Friday.", "friday", id="en-from-possessive-weekday-object-keeps-deadline"),
        pytest.param("Submit feedback from Monday’s meeting by Friday.", "friday", id="en-from-curly-possessive-weekday-object-keeps-deadline"),
        pytest.param("The deadline changed to Friday.", "friday", id="en-deadline-changed-to-weekday"),
        pytest.param("The deadline has moved from Monday to Friday.", "friday", id="en-moved-deadline-uses-new-date"),
        pytest.param("The deadline has not moved from Monday to Friday.", "", id="en-negated-moved-deadline"),
        pytest.param("The deadline might have moved from Monday to Friday.", "", id="en-uncertain-moved-deadline"),
        pytest.param("The deadline changed to maybe Friday.", "", id="en-changed-deadline-with-uncertain-date"),
        pytest.param("The deadline changed to Friday, tentatively.", "", id="en-changed-deadline-with-tentative-qualifier"),
        pytest.param("We will discuss the deadline change on Friday.", "", id="en-deadline-change-discussion-is-not-a-deadline"),
        pytest.param("报告的截止日是周五。", "周五", id="zh-short-deadline-day-noun"),
        pytest.param("报告的截止日不是周五。", "", id="zh-short-deadline-day-keeps-negation"),
        pytest.param("报告的截止日可能是周五。", "", id="zh-short-deadline-day-keeps-uncertainty"),
        pytest.param("报告的截止日。", "", id="zh-short-deadline-day-label-without-date"),
        pytest.param("Submit the report (by Friday).", "friday", id="en-parenthesized-completion-bound"),
        pytest.param("Do not submit the report (by Friday).", "", id="en-parenthesized-bound-keeps-action-negation"),
        pytest.param("Maybe submit the report (by Friday).", "", id="en-parenthesized-bound-keeps-action-uncertainty"),
        pytest.param("Submit the report (by Friday), tentatively.", "", id="en-parenthesized-bound-keeps-tentative-qualifier"),
        pytest.param("Submit the report (by Friday.", "", id="en-parenthesized-bound-requires-closing-parenthesis"),
        pytest.param("Submit the report. (by Friday).", "", id="en-parenthesized-bound-cannot-borrow-prior-sentence"),
        pytest.param("Submit the report (by Friday. Review tomorrow).", "", id="en-parentheses-cannot-cross-a-real-sentence-boundary"),
        pytest.param("Hold a meeting (by Friday).", "", id="en-parenthesized-bound-needs-completion-context"),
    ],
)
