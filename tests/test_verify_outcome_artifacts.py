...
@pytest.mark.parametrize(
    ...
    [
        ...
        (f"- [Observed] ghp_abcd<!DOCTYPE html>{FAKE_GITHUB_TOKEN.removeprefix('ghp_')[4:]}. ([Sources: issue](https://github.com/org/repo/issues/1))", "private path or secret-like text"),
        (f"- [Observed] ghp_abcd<?probe?>{FAKE_GITHUB_TOKEN.removeprefix('ghp_')[4:]}. ([Sources: issue](https://github.com/org/repo/issues/1))", "private path or secret-like text"),
        (f"- [Observed] ghp_abcd<![CDATA[probe]]>{FAKE_GITHUB_TOKEN.removeprefix('ghp_')[4:]}. ([Sources: issue](https://github.com/org/repo/issues/1))", "private path or secret-like text"),
